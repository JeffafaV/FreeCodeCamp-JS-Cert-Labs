...
const botName = "Bob the bot";
const botLocation = "Your computer";
const favoriteLanguage = "JavaScript";

console.log("My name is " + botName + " and I live on " + botLocation + ".");
console.log("My favorite programming language is " + favoriteLanguage + ".");

let codingFact = favoriteLanguage + " is used for web development.";
console.log(codingFact);

codingFact =
  "You can do many things with " +
  favoriteLanguage +
  " like manipulating DOM elements and adding interactivity to your website.";
console.log(codingFact);

codingFact =
  "Another thing you can do with " +
  favoriteLanguage +
  " is make API requests!";
console.log(codingFact);
